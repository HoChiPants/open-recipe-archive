...
test("extracts and normalizes a Schema.org Recipe", () => {
  const html = `<script type="application/ld+json">${JSON.stringify({
    "@context": "https://schema.org", "@type": "Recipe", name: "Test Soup", prepTime: "PT10M", cookTime: "PT30M",
    totalTime: "PT45M", recipeYield: "4 bowls", recipeIngredient: ["2 cups broth"],
    recipeInstructions: [{ "@type": "HowToStep", text: "Simmer gently." }]
  })}</script>`;
